        ...
        return (
            <div>
                ...
                <GridList cols={5} className={classes.gridListUpcomingMovies} >
                    {this.state.upcomingMovies && this.state.upcomingMovies.map((movie, key) => (
                        <GridListTile key={"upcoming" + movie._id} id={key}>
                ...
                <div className="flex-container">
                    <div className="left">
                        <GridList cellHeight={350} cols={4} className={classes.gridListMain}>
                            {this.state.releasedMovies && this.state.releasedMovies.map(movie => (
                        ...
                        <Card>
                            <CardContent>
                                ...
                                <FormControl className={classes.formControl}>
                                    ...
                                    >
                                        {this.state.genresList && this.state.genresList.map(genre => (
                                ...
                                <FormControl className={classes.formControl}>
                                    ...
                                    >
                                        {this.state.artistsList && this.state.artistsList.map(artist => (
